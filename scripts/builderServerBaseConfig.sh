...
# #add user
# useradd -m -G wheel -s /bin/bash lenny
# #adjust sudoers
...
# chown builder:http /home/lenny
# chmod 750 /home/lenny
# #link it up
# ln -sf /writable/repo-packages /home/lenny/repo-packages
...
# pacman-key --add /home/lenny/.keystuff/public.key
...
# echo -e "\n[aur-packages]\nServer = file:///home/lenny/repo-packages/aur-packages\n" >> /etc/pacman.conf
# echo -e "\n[custom-packages]\nServer = file:///home/lenny/repo-packages/custom-packages\n" >> /etc/pacman.conf
# echo -e "\n[meta-packages]\nServer = file:///home/lenny/repo-packages/meta-packages\n" >> /etc/pacman.conf
